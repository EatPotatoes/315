...
data %>% 
  ...
  labs(title = "5 Year Moving Average of Global Video Game Sales",
       x = "Release Year", y = "Global Sales (millions)")
```
...
Pivoting to our third research question, examining which factors impact
...
data %>%
  ...
  labs(title = "Global Sales Over Time by Genre",
...
In this project, we looked at how physical video game sales vary over time, 
across regions, and between genres, as well as which factors are most strongly 
associated with success. We found notable growth in total sales from the 
1980s through the mid-2000s, followed by a slight plateu in recent years,
though the fact that this dataset contains only physical sales must be 
considered. Regional market shares shifted over time as well, with North 
America consistently dominating overall sales, Japan playing a major role in 
earlier decades, and Europe growing steadily to become a major contributor by 
the 2000s.

Genre preferences also differed significantly across regions. Our chi-square 
test also found that North America, Europe, and Japan have distinct sales 
distributions by genre, with Japan’s strong emphasis on role-playing games 
standing in contrast to the action-, shooter-, and sports-heavy markets of North 
America and Europe. These differences highlight how cultural preferences could
shape the demand for different types of games.

Finally, when considering factors that may influence global sales, we found 
patterns across release year, platform type, and even game titles. Platform 
analysis revealed different trajectories, with Nintendo and PlayStation titles 
showing decreasing sales per game and Xbox titles trending upward. Once again, 
we might consider the emergence of selling games digitally as a possible factor 
here. Also, the word cloud comparison suggested that franchise recognition is
important in commercial top-selling games, indicating the importance of branding
and popularity for consumers in the industry

Overall, our findings show that video game sales are shaped by a combination of 
time-based trends, regional preferences, differences in genre and platform, and
how well known a franchise is . While limited to physical game sales, the 
dataset provides valuable insight into the structure and evolution of the 
industry.
